...
import { getMockUserById, updateMockUser } from '../config/mockDb.js';
...
export const getProfile = async (req, res) => {
  const user = getMockUserById(req.userId);
  if (!user) {
...
export const updateProfile = async (req, res) => {
  ...
  const updatedUser = updateMockUser(req.userId, { profile: { ...user.profile, ...updates } });
...
export const changePassword = async (req, res) => {
  ...
  updateMockUser(req.userId, { passwordHash });
