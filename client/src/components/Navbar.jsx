      ...
      <div className="app-navbar-container">
        <div className="app-navbar-row">
          ...
          <div className="app-navbar-actions">
            ...
            <button type="button" className="app-navbar-login" onClick={() => navigate('/login')}>Log In</button>
            <button type="button" className="app-navbar-cta" onClick={() => navigate('/register')}>Get Started</button>
          </div>
